  ...
  return (
    <div className='testimonials' id='testimonials'>
        <div className="left-t">
            ...
            <span style={{fontSize:'3rem'}}>Say About Us</span>
            <motion.span key={selected} initial={{opacity:0, x:-100}} animate ={{opacity:1, x:0}} exit={{opacity:0, x:-100}} transition={transition} style={{color:'white'}}>
        ...
        <div className="right-t">
            ...
            <motion.div initial={{opacity:0, x:100}} whileInView={{opacity:1, x:0}} transition={{...transition, duration: 2}}></motion.div>
              ...
              <div className="arrows">
                ...
                <img onClick={()=> selected === tlen - 1 ? setSelected(0) : setSelected((prev) => prev + 1)} src={rightArrow} alt="" />
              </div>
        </div>
